...
ms.locfileid: "11617989"
---
# <a name="microsoft-edge-webview2---policies"></a><span data-ttu-id="10a24-103">Microsoft Edge WebView2: directivas</span><span class="sxs-lookup"><span data-stu-id="10a24-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <a name="available-policies"></a><span data-ttu-id="10a24-108">Directivas disponibles</span><span class="sxs-lookup"><span data-stu-id="10a24-108">Available policies</span></span>
...
### [*<a name="loader-override-settings"></a><span data-ttu-id="10a24-112">Configuración de invalidación de Loader</span><span class="sxs-lookup"><span data-stu-id="10a24-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="10a24-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="10a24-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="10a24-118">Establezca las preferencias de pedido de búsqueda de canal de publicación</span><span class="sxs-lookup"><span data-stu-id="10a24-118">Set the release channel search order preference</span></span>|
  ...
  ## <a name="loader-override-settings-policies"></a><span data-ttu-id="10a24-119">Directivas de configuración de invalidación de Loader</span><span class="sxs-lookup"><span data-stu-id="10a24-119">Loader Override Settings policies</span></span>
  ...
  ### <a name="browserexecutablefolder"></a><span data-ttu-id="10a24-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="10a24-121">BrowserExecutableFolder</span></span>

  #### <a name="configure-the-location-of-the-browser-executable-folder"></a><span data-ttu-id="10a24-122">Configure la ubicación de la carpeta ejecutable del explorador</span><span class="sxs-lookup"><span data-stu-id="10a24-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="10a24-123">Versiones compatibles:</span><span class="sxs-lookup"><span data-stu-id="10a24-123">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="10a24-125">Descripción</span><span class="sxs-lookup"><span data-stu-id="10a24-125">Description</span></span>
...
<span data-ttu-id="10a24-128">Para establecer el valor de la ruta de acceso de la carpeta, especifique un par de valor y nombre de valor.</span><span class="sxs-lookup"><span data-stu-id="10a24-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="10a24-129">Configure el nombre de valor en el ID. del modelo de usuario de la aplicación o en el nombre del archivo ejecutable.</span><span class="sxs-lookup"><span data-stu-id="10a24-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="10a24-130">Puede usar el carácter comodín "\*" como nombre de valor para aplicar a todas las aplicaciones.</span><span class="sxs-lookup"><span data-stu-id="10a24-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="10a24-131">Características admitidas:</span><span class="sxs-lookup"><span data-stu-id="10a24-131">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="10a24-135">Tipo de datos:</span><span class="sxs-lookup"><span data-stu-id="10a24-135">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="10a24-137">Información y configuración de Windows</span><span class="sxs-lookup"><span data-stu-id="10a24-137">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="10a24-138">Información de directiva de grupo (ADMX)</span><span class="sxs-lookup"><span data-stu-id="10a24-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="10a24-144">Configuración del Registro de Windows</span><span class="sxs-lookup"><span data-stu-id="10a24-144">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="10a24-149">Valor de ejemplo:</span><span class="sxs-lookup"><span data-stu-id="10a24-149">Example value:</span></span>
...
```
  ...
  ### <a name="releasechannelpreference"></a><span data-ttu-id="10a24-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="10a24-151">ReleaseChannelPreference</span></span>

  #### <a name="set-the-release-channel-search-order-preference"></a><span data-ttu-id="10a24-152">Establezca las preferencias de pedido de búsqueda de canal de publicación</span><span class="sxs-lookup"><span data-stu-id="10a24-152">Set the release channel search order preference</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="10a24-153">Versiones compatibles:</span><span class="sxs-lookup"><span data-stu-id="10a24-153">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="10a24-155">Descripción</span><span class="sxs-lookup"><span data-stu-id="10a24-155">Description</span></span>
...
<span data-ttu-id="10a24-158">Para establecer el valor de las preferencias de canal de liberación, especifique un nombre de valor y un par de valores.</span><span class="sxs-lookup"><span data-stu-id="10a24-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="10a24-159">Configure el nombre de valor en el ID. del modelo de usuario de la aplicación o en el nombre del archivo ejecutable.</span><span class="sxs-lookup"><span data-stu-id="10a24-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="10a24-160">Puede usar el carácter comodín "\*" como nombre de valor para aplicar a todas las aplicaciones.</span><span class="sxs-lookup"><span data-stu-id="10a24-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="10a24-161">Características admitidas:</span><span class="sxs-lookup"><span data-stu-id="10a24-161">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="10a24-165">Tipo de datos:</span><span class="sxs-lookup"><span data-stu-id="10a24-165">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="10a24-167">Información y configuración de Windows</span><span class="sxs-lookup"><span data-stu-id="10a24-167">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="10a24-168">Información de directiva de grupo (ADMX)</span><span class="sxs-lookup"><span data-stu-id="10a24-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="10a24-174">Configuración del Registro de Windows</span><span class="sxs-lookup"><span data-stu-id="10a24-174">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="10a24-179">Valor de ejemplo:</span><span class="sxs-lookup"><span data-stu-id="10a24-179">Example value:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="10a24-181">Consulta también</span><span class="sxs-lookup"><span data-stu-id="10a24-181">See also</span></span>
