...
Si dispones de una aplicación en la que no se cumple esta promesa, apoyaremos la promesa de solucionarlo con [Microsoft App Assure](https://www.microsoft.com/fasttrack/microsoft-365/desktop-app-assure).
