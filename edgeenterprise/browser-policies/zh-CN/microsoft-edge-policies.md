...
|[扩展](#扩展)|[本机消息](#本机消息)|
|[默认的搜索提供程序](#默认的搜索提供程序)|[Adicional](#additional)|
...
为使此策略按预期工作， [BrowserSignin](#browsersignin) 策略必须未配置或必须设置为启用。如果将 [BrowserSignin](#browsersignin) 设置为禁用，则 [ForceSync](#forcesync) 将不起作用。
